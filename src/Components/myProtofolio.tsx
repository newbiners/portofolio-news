...
const MyPortofolio = () => {
    return (
        <div className="mt-24 2xl:mt-44" id="portofolio">
            ...
            <div className="mt-10 px-5 sm:px-0 flex justify-center gap-10">
                <Link href={"https://github.com/newbiners/mobileKomiknime"}>
                    <Image src={'/komikku.jpg'} data-aos="fade-up"
                        data-aos-anchor-placement="bottom-bottom" alt="porto-1" height={600} width={800} className="h-[13rem] min-[400px]:h-[15rem] min-[400px]:w-[25rem] sm:w-[30rem] md:h-[16rem] md:w-[30rem] lg:w-[35rem] lg:h-[20rem] xl:h-[23rem] xl:w-[40rem] 2xl:h-[30rem] 2xl:w-[60rem] object-cover rounded-xl shadow-2xl brightness-90 hover:brightness-100" />
                </Link>
            </div>
        </div>
    )
